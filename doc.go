...
configuration file. As generated by "ysco configdefaults":
	...
	Policy:
		...
		# Values: patch, minor, manual. (optional)
		Service: patch

		# Policy for updating when a new version of ysco is discovered. Values: patch,
		# minor, manual. (optional)
		Self: patch

		# Policy for updating the monitored service when a new Go toolchain is discovered.
		# Values: patch, minor, manual, supported, follow. (optional)
		ServiceToolchain: follow

		# Policy for updating ysco when a new Go toolchain is discovered. Values: patch,
		# minor, manual, supported, follow. (optional)
